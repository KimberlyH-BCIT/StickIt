...
public static class ServiceCollectionExtensions
{
    ...
    {
        services.Configure<Configuration.CacheOptions>(configuration.GetSection("Cache"));
        services.Configure<Configuration.SearchOptions>(configuration.GetSection("Search"));
        services.Configure<Configuration.EmailOptions>(configuration.GetSection("Email"));
        services.Configure<Configuration.ModerationOptions>(configuration.GetSection("Moderation"));
        services.Configure<Configuration.PayPalOptions>(configuration.GetSection("PayPal"));
        services.Configure<Configuration.ReCaptchaOptions>(configuration.GetSection("ReCaptcha"));
