...
namespace ELKH.Repositories
{
    ...
    public interface IContactDetailRepo
    {
        ...
        /// </summary>
        Task<bool> AddAndSaveAsync(ContactDetailModel contact);

        /// <summary>Updates an existing address, applying the same default-flag enforcement as <see cref="AddAndSaveAsync"/>.</summary>
        Task<bool> UpdateAndSaveAsync(ContactDetailModel contact);
