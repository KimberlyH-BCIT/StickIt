...
namespace ELKH.Controllers
{
    public class UserController : AuthenticatedControllerBase
    {
        ...
        public async Task<IActionResult> EditAddress(int id)
        {
            ...
            if (userId is null || contact is null || contact.FkRegisteredUserId != userId.Value)
            {
        ...
        public async Task<IActionResult> MyRatings(string sort = "purchase_desc")
        {
            ...
            IEnumerable<UserRatingVM> vms = sort switch
            {
                ...
                "name_asc" => ratings.OrderBy(r => r.ProductName),
                "name_desc" => ratings.OrderByDescending(r => r.ProductName),
